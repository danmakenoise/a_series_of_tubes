...
describe ASeriesOfTubes::TubeController do
  before :all do
  ...
  describe '#session' do
    it 'returns a session instance' do
      expect(cats_controller.session).to be_a ASeriesOfTubes::TubeState::Session
    end
  ...
  describe '#flash' do
    it 'returns a flash instance' do
      expect(cats_controller.flash).to be_a ASeriesOfTubes::TubeState::Flash
    end
