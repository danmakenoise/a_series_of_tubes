...
describe ASeriesOfTubes::Tubes::Tube do
  ...
  describe "#matches?" do
    it 'matches simple regular expression' do
      index_tube = ASeriesOfTubes::Tubes::Tube.new Regexp.new('^/users$'), :get, "_", :_
    ...
    it 'matches regular expression with capture' do
      index_tube = ASeriesOfTubes::Tubes::Tube.new users_regex, :get, "_", :_
  ...
  describe '#run' do
    ...
    it 'instantiates controller' do
      ...
      index_tube = ASeriesOfTubes::Tubes::Tube.new Regexp.new('^/users$'), :get, dummy_class, :index
    ...
    it 'generates proper params' do
      ...
      index_tube = ASeriesOfTubes::Tubes::Tube.new users_regex, :get, dummy_class, :index
